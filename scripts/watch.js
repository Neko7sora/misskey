...
chokidar
	.watch("./../packages/backend/src/server/web/views/**/*")
	.on("all", (event, path) => {
...
chokidar
	.watch("./../packages/frontend/node_modules/three/examples/fonts/**/*")
	.on("all", (event, path) => {
...
chokidar
	.watch("./../packages/frontend/node_modules/@tabler/icons-webfont/**/*")
	.on("all", (event, path) => {
